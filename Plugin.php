...
<?php
    ...
    editor.hooks.chain('makeButton', function(buttons, makeButton, bindCommand, ui) {
        buttons.minty = makeButton('wmd-minty-button', '音乐 [Minty] Ctrl+X', '0', function(chunk, postProcessing) {
            ...
            ui.prompt("<p><b>插入音乐</b></p><p>1. 服务支持两种: 网易云音乐(nets) 和虾米(xiami): <b>1 或 0</b></p><p>2. 自动(auto) 和循环(loop): <b>1 或 0</b></p><p>3. 类型: 单曲(song),列表(list),专辑(album),精选集(collect)</p><p>4. 输入框可以输入虾米单曲、专辑、精选集或列表的ID如:<br><b>单曲: 1773431302; 列表: 1769023557,2091668</b></p>", '', function(music) {
